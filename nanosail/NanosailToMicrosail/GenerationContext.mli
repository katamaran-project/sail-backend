...
val pp_inductive_type : PP.document -> ?parameters : (PP.document * PP.document) list -> PP.document -> ((?parameters:PPrint.document -> ?typ:PPrint.document -> PPrint.document -> unit t) -> 'a t
) -> PP.document t
