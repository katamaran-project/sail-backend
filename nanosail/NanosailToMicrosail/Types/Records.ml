...
let generate_no_confusions (record_definitions : (Sail.sail_definition * Ast.record_definition) list) =
  let generate_derivation (record_definition : Ast.record_definition) =
