...
\begin{tikzpicture}[
  ...
  \module[id=n2m-foreignkit,name=ForeignKit,below last,submodule of=n2m]{}
  \module[id=n2m-fundeclkit,name=FunDeclKit,below last,submodule of=n2m]{}
  \module[id=n2m-fundefkit,name=FunDefKit,below last,submodule of=n2m]{}
  \module[id=n2m-programmodule,name=ProgramModule,below last,submodule of=n2m]{}
  \module[id=n2m-katamaran,name=Katamaran,below last=1,submodule of=n2m]{
    \begin{itemize}
