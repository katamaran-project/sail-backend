...
\begin{tikzpicture}[
  ...
  \module[id=n2m-musail,name=MuSail,below last,submodule of=n2m]{
    \begin{itemize}
      \item Generation of \microsail~code
    \end{itemize}
  }
  ...
  \module[id=n2m-functioncalls,name=FunctionCalls,below last,submodule of=n2m]{
    \begin{itemize}
      \item Maps Sail functions to \microsail
        \begin{itemize}
          \item \texttt{not\textunderscore bool} $\rightarrow$ \texttt{uop.not}
          \item \texttt{not\textunderscore vec} $\rightarrow$ \texttt{uop.bvnot}
          \item \dots
        \end{itemize}
    \end{itemize}
  }
