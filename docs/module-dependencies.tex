...
\begin{tikzpicture}[
  ...
  \module[id=ast-kind,name=Kind,submodule of=ast,below=ast-numeric-constraint]{}
  ...
  \module[id=ast-definition-function,name=Function,below last=0.75,submodule of=ast-definition]{
    \begin{itemize}
      \item Function name, type (incomplete), body
      \item Holds list of monomorphs
    \end{itemize}
  }
  \draw[dependency] (ast-definition-function--box.north) -- (ast-definition-functiontype--box.south);
